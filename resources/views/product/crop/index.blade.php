        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-10 order-lg-last">
                    <div class="row">
                        @foreach($fertilizers as $product)
                        <div class="col-sm-2">
                ...
                <div class="col-lg-2">
                    <div class="pa-product-sidebar">
                        ...
                        <div class="pa-widget pa-shop-category">
                            <h2 class="pa-sidebar-title">Группы культур</h2>
                            <ul>
                                @foreach($crops as $crop)
                                <li><a href="{{route('product.crop.index',$crop->id)}}">{{$crop->title}} <span>{{$crop->fertilizers()->count()}}</span></a></li>
                                @endforeach
                            </ul>
                        </div>
